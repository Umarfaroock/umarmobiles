...
<form class="form-horizontal" action="addSupplier" method="post" onsubmit="return formCategory()" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">SuppliertName :</label>
    <div class="col-sm-3"> 
      <input type="text" class= "form-control" name="supplierName" value="${supplier.supplierName}">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">SupplierDescription :</label>
    <div class="col-sm-3"> 
