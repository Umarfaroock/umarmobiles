...
<form class="form-horizontal" action="addCategory" method="post" onsubmit="return formCategory()" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" name="categoryName" id="categoryname" placeholder="Enter Category type">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">Description :</label>
    <div class="col-sm-3"> 
      <input type="text" class="form-control" name="categoryDescription" id="categorydescription" placeholder="Enter description">
    </div>
  </div>
  <div class="form-group"> 
